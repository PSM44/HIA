// ========== HIA REAL READ-ONLY STATE ==========
// ID_UNICO..........: PRJPB_009N_C_REAL_READONLY_STATE
// GENERATED_AT......: 2026-06-05 14:02:26 -0400
...
window.HIA_REAL_STATE = Object.freeze({
  project: Object.freeze({
    ...
    head_short: "e39f7ba",
    head_message: "20260604_HIA_session_close_after_PRJPB_009N_B"
  }),
  continuity: Object.freeze({
    next_action: "PRJPB_009N-C | implementar estado real read-only visible en Control Tower Shell | ready",
    baton_snapshot: "PRJPB_009N-C | implementar estado real read-only visible en Control Tower Shell | ready",
    evidence_state: "- EVIDENCE_STATE: FRESH.",
    session_status: "closed",
    source: "BATON/BACKLOG/HIA CLI",
    generated_local: "2026-06-05 14:02:26 -0400"
  }),
  radar: Object.freeze({
  ...
  ui: Object.freeze({
    shell_file: "01_UI/web/client-shell/index.html",
    state_file: "01_UI/web/client-shell/hia.state.js",
    mode: "read-only visible state",
    minibattle: "PRJPB_009N-C"
  }),
